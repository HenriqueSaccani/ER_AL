...
''' This code create the standard plots, used in the abstract paper.
    The plots are divided by 4 types:
    dataset: A tsplot for each dataset, showing the standard variation 
            of 100,200,300,400, 500 budget in the specific dataset. (4 in total)
...
for dataset in datasets.keys():
    ...
    for n, bud in enumerate(organized_rec_dict.keys()):
        ...
        plt.savefig(f"standard_tesis/{dataset}_{bud}.png")
        plt.show()
...
for dataset in datasets.keys():
    ...
    plt.savefig(f"standard_tesis/{dataset}.png")
    plt.show()
...
plt.legend()
plt.grid(True)
plt.savefig(f"standard_tesis/abtBuy+amazonGoogleProducts.png")
plt.show()
...
plt.legend()
plt.grid(True)
plt.savefig(f"standard_tesis/DblpAcm+scholarDblp.png")
plt.show()
...
for i in range(2):
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig(f"standard_tesis/abtBuy+amazonGoogleProducts_{budget}.png")
    plt.show()
...
for i in range(2):
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig(f"standard_tesis/DblpAcm+scholarDblp_{budget}.png")
    plt.show()
'''
